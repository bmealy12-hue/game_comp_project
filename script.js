...
// const games = [
  {
    title: "Elden Ring",
    image: "https://placehold.co/300x160/1a1a2e/ffffff?text=Elden+Ring",
    rating: "9.5",
    genres: ["Action", "RPG"],
    platforms: ["PC","Playstation","Xbox","Nintendo"],
    prices:[
      { store: "Steam", price: "$49.99" },
      { store: "GOG", price: "$59.99" },
      { store: "Epic Games Store", price: "$59.99" }
    ],
    bestDeal: "Steam"
  },
  {
    title: "God of War (2018)",
    image: "https://placehold.co/300x160/1a1a2e/ffffff?text=God+Of+War",
    rating: "9.8",
    genres: ["Action", "RPG"],
    platforms: ["PC", "Playstation"],
    prices: [
      { store: "Steam", price: "$39.99" },
      { store: "PlayStation Store", price: "$49.99" }
    ],
    bestDeal: "Steam"
  },
  {
    title: "Resident Evil 2 Remake",
    image: "https://placehold.co/300x160/1a1a2e/ffffff?text=Resident+Evil+2+Remake",
    rating: "9.6",
  ...
  {
    title: "Hades 2",
    image: "https://placehold.co/300x160/0d3b00/ffffff?text=Hades+2",
    rating: "9.7",
    genres: ["Indie", "RPG"],
    platforms: ["PC", "Playstation", "Xbox"],
    prices: [
      { store: "Steam", price: "$24.99" },
      { store: "Epic Games Store", price: "$29.99" }
    ],
    bestDeal: "Steam"
  },
  {
    title: "Baldur's Gate 3", 
    image: "https://placehold.co/300x160/2d0038/ffffff?text=Baldur%27s+Gate+3",
    rating: "9.9",
    genres: ["Strategy", "RPG"],
    platforms: ["PC", "Playstation"],
    prices: [
      { store: "Steam", price: "$54.99" },
      { store: "GOG", price: "$59.99" }
    ],
    bestDeal: "Steam"
  }
